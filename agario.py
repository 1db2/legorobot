...
def RandomCircle():
    rR = rand.randint(player.r-8, player.r+5)
...
while ingame:
    ev3.screen.draw_text(0, 0, "Score: " + str(score), Color.BLACK, None)
    ev3.screen.draw_circle(player.x, player.y, player.r,
...
ev3.screen.print("Final score: " + str(score))
wait_for_button(ev3)
